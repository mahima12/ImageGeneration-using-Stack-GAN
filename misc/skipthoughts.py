...
path_to_models = 'C:/Users/user/Desktop/st/8Sem/skip-thoughts-master/StackGAN-master/models/demo/stageI/stageII/misc/Data/skipthoughts/'
#path_to_tables = 'Data/skipthoughts/'
path_to_tables = 'C:/Users/user/Desktop/st/8Sem/skip-thoughts-master/StackGAN-master/models/demo/stageI/stageII/misc/Data/skipthoughts/'
#-----------------------------------------------------------------------------#
...
def load_tables():
    #load the tables
    words = []
    path_to_utable = path_to_tables + 'utable.npy'
    path_to_btable = path_to_tables + 'btable.npy'
