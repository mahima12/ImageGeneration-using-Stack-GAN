...
from stageI.stageII.misc.config import cfg, cfg_from_file
from stageI.stageII.misc.utils import mkdir_p
from stageI.stageII.misc import skipthoughts
from stageI.stageII.model import CondGAN
...
def drawCaption(img, caption):
    ...
    # get a font
    fnt = ImageFont.truetype('C:/Users/user/Anaconda3/Lib/site-packages/PIL/FreeMono.ttf', 50)
...
if __name__ == "__main__":
  ...
  #  cap_path = "stageI\\stageII\\misc\\Data\\birds\\example_captions.txt"
    ...
    with open(cap_path) as f:
        ...
        #split this string into a list of strings by calling the .split method.
